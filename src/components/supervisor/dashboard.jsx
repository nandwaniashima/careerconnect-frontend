...
const UsersList = () => {
  ...
  useEffect(() => {
    const fetchCompanies = async () => {
      try {
        const response = await axios.get("http://localhost:8000/api/v1/company/getAllCompanies");
    ...
    const fetchApplications = async () => {
      try {
        const response = await axios.get("http://localhost:8000/api/v1/application/getallapplications");
